...
import { 
  ...
  Cpu, ArrowRight, Share2, Music, BookOpen, 
  TrendingUp, Users, Cpu as Chips, Zap as Power
} from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-60">
      ...
      {/* Hero: Institutional Aesthetic */}
      <section className="relative pt-6 lg:pt-12 pb-16 px-8 lg:px-16 overflow-hidden">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-12">
            <div className="max-w-5xl space-y-6 relative">
              ...
              <div className="flex flex-col md:flex-row gap-12 items-start">
                 <p className="text-slate-400 text-2xl lg:text-3xl leading-snug font-light max-w-2xl border-l-2 border-indigo-500/20 pl-10 font-serif">
                    The variables that once governed relevance—<span className="text-slate-200">scale, incumbency, capital</span>—yielded to new ones: <span className="text-slate-200 italic font-serif underline decoration-indigo-500/30 underline-offset-8">learning velocity and system coherence</span>.
                 </p>
            ...
            {/* Dash: Quantitative Signals */}
            <div className="grid grid-cols-2 gap-4 w-full xl:w-[540px]">
               <div className="p-8 glass-dex-ultra rounded-[2.5rem] border-white/5 space-y-4">
                  <Users className="text-indigo-400" size={20} />
                  <div className="text-[9px] font-black text-slate-600 uppercase tracking-widest">Global Reach</div>
                  <div className="text-4xl font-bold text-white tracking-tighter">800M+ <span className="text-[10px] text-slate-600">Active</span></div>
               </div>
               <div className="p-8 glass-dex-ultra rounded-[2.5rem] border-white/5 space-y-4">
                  <Power className="text-amber-400" size={20} />
                  <div className="text-[9px] font-black text-slate-600 uppercase tracking-widest">Grid Impact</div>
                  <div className="text-4xl font-bold text-white tracking-tighter">500 TWh</div>
               </div>
               <div className="p-8 glass-dex-ultra rounded-[2.5rem] border-white/5 space-y-4">
                  <TrendingUp className="text-emerald-400" size={20} />
                  <div className="text-[9px] font-black text-slate-600 uppercase tracking-widest">Market Scale</div>
                  <div className="text-4xl font-bold text-white tracking-tighter">$300B</div>
               </div>
               <div className="p-8 glass-dex-ultra rounded-[2.5rem] border-white/5 space-y-4">
                  <Chips className="text-fuchsia-400" size={20} />
                  <div className="text-[9px] font-black text-slate-600 uppercase tracking-widest">Compute Cap</div>
                  <div className="text-4xl font-bold text-white tracking-tighter">14 exaFLOPS</div>
               </div>
            </div>
          </div>
        </div>
      ...
      {/* Navigation Filter & Command UI (Non-sticky) */}
      <section className="relative z-40 px-8 lg:px-16 py-8 bg-[#010409]/90 backdrop-blur-3xl border-b border-white/5">
      ...
      {showOverview && !searchQuery && (
        <section className="max-w-[1440px] mx-auto px-8 lg:px-16 pt-24 space-y-40">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-start">
              <div className="space-y-10">
                 ...
                 <p className="text-2xl text-slate-400 font-serif leading-relaxed italic border-l-4 border-indigo-500/20 pl-10">
                    "Intelligence ceased to function as an embedded software feature and instead emerged as a civilizational substrate—co-equal with electricity, water, land, capital, and legal structure."
                 </p>
                 <div className="p-10 glass-dex-ultra rounded-[3rem] border-white/5 space-y-6">
                    <div className="text-[11px] font-black text-indigo-400 uppercase tracking-widest flex items-center gap-3">
                       <BarChart3 size={16} /> ADOPTION_VELOCITY_AUDIT
                    </div>
                    <div className="grid grid-cols-2 gap-10">
                       <div className="space-y-2">
                          <div className="text-3xl font-bold text-white">90%</div>
                          <div className="text-[10px] text-slate-500 uppercase font-mono">Enterprise Integration</div>
                       </div>
                       <div className="space-y-2">
                          <div className="text-3xl font-bold text-white">25,000+</div>
                          <div className="text-[10px] text-slate-500 uppercase font-mono">New AI Firms (30/Day)</div>
                       </div>
                    </div>
                 </div>
              </div>
              ...
              <div className="space-y-12">
                 <div className="p-12 glass-dex-ultra rounded-[4rem] border-white/10 space-y-8 relative overflow-hidden bg-white/[0.01]">
                    ...
                    <div className="text-[12px] font-black text-indigo-400 uppercase tracking-[0.5em] mb-4 flex items-center gap-3">
                       <ShieldCheck size={16} /> PHASE_TRANSITION_LOG_25
                    </div>
                    <div className="space-y-6 text-slate-400 text-lg leading-relaxed font-light">
                       <p>
                          In 2025, artificial intelligence crossed a threshold that no prior general-purpose technology traversed at comparable speed. Compute exited abstraction and acquired <strong>geography</strong>.
                       </p>
                       <p>
                          Hyperscale AI campuses—measured in <strong>gigawatts</strong> rather than server racks—entered operation at scales analogous to mid-sized cities. The data center emerged as the factory of the intelligence era.
                       </p>
                       <button 
                       ...
                       >
                          ACCESS DETAILED PROVIDER LOGS <ArrowRight size={20} className="group-hover:translate-x-2 transition-transform" />
                       </button>
                    </div>
                 </div>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="p-8 glass-dex-ultra rounded-[2.5rem] border-white/5">
                       <div className="text-[10px] font-black text-slate-500 uppercase mb-4 tracking-widest">Binding Constraint</div>
                       <div className="text-2xl font-bold text-slate-200">Energy & Water</div>
                       <p className="text-xs text-slate-500 mt-2">Every inference carries a thermodynamic cost. Every query consumes power.</p>
                    </div>
                    <div className="p-8 glass-dex-ultra rounded-[2.5rem] border-white/5">
                       <div className="text-[10px] font-black text-slate-500 uppercase mb-4 tracking-widest">Cognitive Labor</div>
                       <div className="text-2xl font-bold text-slate-200">60–90% Autonomy</div>
                       <p className="text-xs text-slate-500 mt-2">Multi-agent systems assume responsibility for entire process chains.</p>
                    </div>
                 </div>
              </div>
           </div>
      ...
      <main className="max-w-[1440px] mx-auto px-8 lg:px-16 pt-24 space-y-48">
        {(activeCategory === 'Providers' || activeCategory === 'Open') && (
            ...
            <section>
              <div className="flex items-center gap-6 mb-20 px-4">
                 ...
                 <div className="space-y-2">
                    ...
                    <p className="text-slate-500 text-2xl max-w-3xl font-light font-serif italic">Consistent, brand-ready engines defining the 2025 aesthetic.</p>
                 </div>
              </div>
        ...
        <div className="max-w-[1440px] mx-auto px-10">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-40 mb-40">
            <div className="space-y-16">
              <LogoOrb size={100} />
              <h4 className="text-7xl font-black tracking-tighter leading-none uppercase text-white">ZEN AI <br /> <span className="text-indigo-500 italic font-serif">CO.</span></h4>
